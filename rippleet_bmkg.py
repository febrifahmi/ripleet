...
This code collects weather data from data.bmkg.go.id and index it to the PostgreSQL table 
'''
...
# data portal name
dataportalname = 'Data Prakiraan Cuaca'
datasourcename = 'BMKG (Badan Meteorologi, Klimatologi, dan Geofisika)'
...
try:
	...
	create_table_q = '''CREATE TABLE IF NOT EXISTS rippleet_bmkg_cuaca (ID SERIAL PRIMARY KEY NOT NULL, NEWSPORTAL TEXT NOT NULL, TITLE TEXT NOT NULL, CONTENT TEXT NOT NULL, NEWSURL TEXT NOT NULL, NEWSTAG TEXT NOT NULL, PUBDATE DATE NOT NULL);'''
...
urlindonesia = "http://data.bmkg.go.id/datamkg/MEWS/DigitalForecast/DigitalForecast-Indonesia.xml"
